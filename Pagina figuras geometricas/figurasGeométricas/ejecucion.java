    ...
    public static void main(String[] args) {
        ...
        switch(opc){
            ...
            switch(men){
                ...
                hep.setL(20.0);
                hep.calcularPerimetro(hep.getL());
                ...
                hep.setP(34.0);
                hep.setAp(17.0);
                hep.calcularArea(hep.getP(),hep.getAp());
            ...
            switch(men1){
                ...
                obt.setL(23.0);
                obt.calcularPerimetro(obt.getL());
                ...
                obt.setB(26.0);
                obt.setH(38.0);
                obt.calcularArea(obt.getB(), obt.getL());
            ...
            switch(men2){
                ...
                tra.calcularPerimetro(tra.getL());
                    break;
                case 2:
                ...
                tra.setBm(18.0);
                tra.setH(31.0);
                tra.calcularArea(tra.getB(), tra.getBm(), tra.getH());
                    break;
                default:
                System.out.println("Valor incorrecto\nIngrese un valor que esté permitido para el próximo intento");
                    break;
